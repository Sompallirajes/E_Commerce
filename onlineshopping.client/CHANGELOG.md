...
- Create Angular project with ng: `ng new onlineshopping.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`onlineshopping.client.esproj`).
